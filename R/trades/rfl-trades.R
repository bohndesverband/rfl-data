...
var_season <- nflreadr::get_current_season(TRUE)
...
past_trades <- readr::read_csv("https://raw.githubusercontent.com/jak3sch/rfl/main/data/trades/rfl-trades.csv", col_types = "ddTdcccc")
...
if (dim(trade_data_raw)[1] != 0) {
  ...
  readr::write_csv(rbind(past_trades, trade_data), "output.csv")
}
